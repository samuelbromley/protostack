...
<p>Upload the files to your server, in a folder of your choosing, and then edit the inc/settings.php file (you might not even have to do that) - and away you go - a teeny tiny PHP framework with optional flat file fast as fook database. Marvelous!</p>